...
MovesApi.prototype.getAccessToken = function getAccessToken(code, cb) {
  ...
  request.post(this.baseUrl +
    'oauth/v1/access_token?grant_type=authorization_code' +
    '&code=' + code + '&client_id=' + this.options.clientId +
    '&client_secret=' +
...
MovesApi.prototype.verifyToken = function verifyToken(cb) {
  ...
  request.get(this.baseUrl + 'oauth/v1/tokeninfo?access_token=' +
...
MovesApi.prototype.refreshToken = function refreshToken(cb) {
  ...
  '&refresh_token=' + this.options.refreshToken + '&client_id=' +
  this.options.clientId + '&client_secret=' + this.options.clientSecret;
...
MovesApi.prototype.getProfile = function getProfile(cb) {
  ...
  request.get(this.baseUrl + 'api/1.1/user/profile?access_token=' +
  this.options.accessToken, function(error, response, body) {
